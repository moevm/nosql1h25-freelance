    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                // 2) Ищем нужный review в массиве
                const rv = sol.reviews?.find(r => String(r.number) === reviewNumber);
    ...
    return (
        <Container className="mt-4">
            <Card className="shadow-sm">
                <Card.Header>
                    <h3>Ревью #{review.number} к решению №{number}</h3>
                </Card.Header>
                <Card.Body>
